...
import { HiOutlineTag, HiOutlinePlus, HiOutlineSparkles } from 'react-icons/hi'
                    ...
                    <form onSubmit={handleCreate} className="bg-white border border-gray-100 rounded-3xl p-6 shadow-[0_4px_20px_rgb(0,0,0,0.03)] sticky top-24">
                        ...
                        <div className="space-y-4">
                            ...
                            <button
                                type="submit"
                                disabled={saving}
                                className="w-full bg-gradient-to-r from-violet-600 to-fuchsia-600 text-white font-bold py-3 rounded-xl shadow-lg shadow-violet-500/30 hover:shadow-violet-500/40 hover:scale-[1.02] transition-all disabled:opacity-50 flex items-center justify-center gap-2"
                            >
