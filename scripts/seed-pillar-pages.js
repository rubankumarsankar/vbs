            ...
            sections: [
                ...
                },
                {
                    ...
                    data: {
                        ...
                        body: '<p>Digital careers are not defined by titles alone, but by the skills and capabilities that support them. Understanding how roles evolve, what they demand, and how growth happens over time brings structure to career decisions.</p><p class="text-2xl text-transparent bg-clip-text bg-gradient-to-r from-emerald-600 to-teal-600 font-bold py-2">Clarity begins with seeing how skills translate into real professional pathways.</p>'
                    }
                },
                {
                    type: 'text',
