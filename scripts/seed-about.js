...
async function main() {
        ...
        sections: [
            ...
            },
            {
                ...
                data: {
                    ...
                    body: 'We serve a diverse range of individuals at different stages of their digital career journey.',
                    cards: [
                        ...
                        { title: 'Career Transitioners', icon: 'HiOutlineRefresh', description: 'Considering career changes, including those restarting or reshaping careers after personal milestones.' },
                        { title: 'Working Professionals', icon: 'HiOutlineUserGroup', description: 'Looking to stay relevant, adapt to AI-driven changes, and build sustainable digital capability.' }
                    ]
                }
            },
            {
    ...
    if (!page) {
        ...
        console.log('About page exists. Updating title/meta and replacing sections...')
